 ...
 * 
 */
package com.robsonliebke.harpia.configuration;
...
public class ConfigurationProducer {
	...
	public void init() {
		...
		if (stream == null) {
			throw new RuntimeException("Cannot find application.properties configuration file."); // NOSONAR
		}

		try {
			this.properties.load(stream);
		} catch (final IOException e) {
			throw new RuntimeException("Configuration file cannot be loaded."); // NOSONAR
		}
	}
